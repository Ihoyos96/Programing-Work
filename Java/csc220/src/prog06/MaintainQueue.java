...
public class MaintainQueue {
  ...
  public void processCustomers() {
    ...
    while (true) {
      ui.sendMessage("People in queue are:\n" + this);
  ...
  public String toString() {
	String s = "";
	for (Iterator<String> customerNames = customers.iterator(); customerNames.hasNext();){
	      s = s + customerNames.next() + "\n";
